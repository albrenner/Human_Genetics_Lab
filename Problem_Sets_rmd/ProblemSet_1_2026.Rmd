...
**Due Date: Friday April 17, 11:59pm**
...
```         
ssh yourUserName@augrabies.genomecenter.ucdavis.edu
```

Then navigate to our ant157 student folder 

```
cd /share/hennlab/CourseANT157L/Students
```    
...
`/share/hennlab/CourseANT157L/data/Ethiopians` directory.
...
```         
plink --bfile /share/hennlab/CourseANT157L/data/Ethiopians/Ethiopians_chr1 --freq
```
